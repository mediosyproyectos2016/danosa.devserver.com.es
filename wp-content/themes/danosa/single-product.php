							    ...
							    <div class="wp-block-group alignfull has-background" id="product-bar" style="background-color:#eef3f6">
							        <div class="wp-block-group__inner-container">
							            <div class="wp-block-buttons">
							                <div class="wp-block-button"><a target="_blank" id="datasheet-button" class="wp-block-button__link download" href="<?php the_permalink(); ?>?pdf&download"><?php _e("Datasheet","danosa"); ?></a></div>
