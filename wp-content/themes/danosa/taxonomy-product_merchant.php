...
$parentID = get_term_top_most_parent($currentTermID, 'product_merchant');

$icon = get_field('icon', 'product_merchant_'.$parentID);
$image = get_field('image', 'product_merchant_'.$parentID);
$description = get_field('description', 'product_merchant_'.$parentID);
$short_description = get_field('short_description', 'product_merchant_'.$parentID);
$color = get_field('color', 'product_merchant_'.$parentID);
				...
				<div id="family-container" class="wp-block-columns">
					<div id="family-left" class="wp-block-column" style="flex-basis:33.33%">
						<div id="menu-families">
							<?php
							echo get_family_tree('product_merchant',$parentID); ?>
						</div>
					</div>
					...
					<div id="family-right" class="wp-block-column" style="flex-basis:66.66%">
		            	...
		            	<div id="family-header">
					        ...
					        <p><?php echo get_field('description', "product_merchant_".$currentTermID); ?></p>
					    </div>
		            	<?php }else{ ?>
		            	<div id="family-header">
	                        		...
	                        		<div id="products-filters-mobile">
										...
										<div class="et_pb_text_inner">
											...
											<form action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="filter">
												...
												<?php
												$countFilters = 0;
												// Se rellena desde la función set_select
