...
function my_acf_init_block_types() {
    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        acf_register_block_type(array(
            ...
            'description'       => __('A custom Delegations block.'),
            'render_template'   => 'blocks/delegations.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
            'keywords'          => array( 'delegations', 'quote' ),
        ));

        acf_register_block_type(array(
            'name'              => 'Sales',
            'title'             => __('Sales'),
            'description'       => __('A custom Sales block.'),
            'render_template'   => 'blocks/sales.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
            'keywords'          => array( 'sales', 'quote' ),
        ));
    }
}
...
function get_system_list($taxonomy = "system_cat", $termId = null, $hreflang_ref = null){
    ...
    if ( $the_query->have_posts() ) {
        ...
        while ( $the_query->have_posts() ) {
            ...
            <li <?php echo $data; ?>><a href="<?php the_permalink(); ?>"><span class="subsystem-system-title"><i class="danosa-arrow-go"></i><?php echo end($title); ?></span><span class="subsystem-system-name"><?php echo get_the_content(null,false); ?></span></a></li>
